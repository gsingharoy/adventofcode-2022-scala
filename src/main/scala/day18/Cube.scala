...
case class Cube(origin: (Int, Int, Int), edge: Int = 1) {
  ...
  private lazy val sides: List[List[(Int, Int, Int)]] = {
    ...
    List(
      ...
      List((x + edge, y, z), (x+edge,y + edge, z), (x+edge, y+edge, z + edge), (x+ edge, y, z+edge)).sorted,
      List((x + edge, y + edge, z), (x,y + edge, z), (x, y+edge, z + edge), (x+ edge, y+edge, z+edge)).sorted,
      List((x , y + edge, z), (x,y,z), (x, y, z + edge), (x, y+edge, z+edge)).sorted,
      List((x , y , z + edge), (x + edge,y , z + edge), (x+edge, y+edge, z + edge), (x, y+edge, z+edge)).sorted,
  ...
  def hasAdjacentSides(that: Cube): Boolean = {
    ...
    if ((this.origin._1 - that.origin._1).abs > edge + 2 ||
