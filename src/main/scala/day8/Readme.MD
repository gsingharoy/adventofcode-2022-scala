...
1. Looking left, its view is not blocked; it can see 2 trees.
1. Looking down, its view is also not blocked; it can see 1 tree.
1. Looking right, its view is blocked at 2 trees (by a massive tree of height 9).
