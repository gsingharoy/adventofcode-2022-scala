 ...
 *
 * @param sourceStack identifier of the crate stack source from where crates have to be moved
 * @param sinkStack Sink or the end stack to which the crates would be moved
 * @param moveUnits Units of crates to be moved from source to sink
 */
...
object MoveAction {
   ...
   * @param str should be of the format "move 1 from 2 to 1"
   *
   * @return
   */
